// Type definitions for Tabris.js 3.7.1
...
export class ColorResources extends Resources<Color, ColorValue> {
   ...
   * @param data The raw data (plain object) to create the dictionary from. The format must match the [Tabris.js colors JSON schema](https://github.com/eclipsesource/tabris-js/blob/v${doc:moduleversion}/schema/colors.json).
   */
...
export class FontResources extends Resources<Font, FontValue> {
   ...
   * @param data The raw data (plain object) to create the dictionary from. The format must match the [Tabris.js fonts JSON schema](https://github.com/eclipsesource/tabris-js/blob/v${doc:moduleversion}/schema/fonts.json).
   */
   ...
   * fonts JSON
   * schema](https://github.com/eclipsesource/tabris-js/blob/v${doc:moduleversion}/schema/fonts.json).
   * Entries in the "data" object starting with "$" are considered configuration options and will not
   * become entries in the final fonts dictionary.
   * @param data The raw data (plain object) to create the dictionary from. The format must match the [Tabris.js fonts JSON schema](https://github.com/eclipsesource/tabris-js/blob/v${doc:moduleversion}/schema/fonts.json).
   */
...
export class Observable<T> {
   ...
   * scroll offsets will trigger the observable.
   * @param source
   */
...
export class TextResources extends Resources<string, string> {
   ...
   * @param data The raw data (plain object) to create the dictionary from. The format must match the [Tabris.js texts JSON schema](https://github.com/eclipsesource/tabris-js/blob/v${doc:moduleversion}/schema/texts.json).
   */
   ...
   * texts JSON
   * schema](https://github.com/eclipsesource/tabris-js/blob/v${doc:moduleversion}/schema/texts.json).
   * Entries in the "data" object starting with "$" are considered configuration options and will not
   * become entries in the final texts dictionary.
   * @param data The raw data (plain object) to create the dictionary from. The format must match the [Tabris.js texts JSON schema](https://github.com/eclipsesource/tabris-js/blob/v${doc:moduleversion}/schema/texts.json).
   */
